...
const TOOLS = [
  {
    ...
    stores:
      "Your .ipynb notebooks during the session. Forgets everything when closed — always save outputs to Drive.",
  ...
  },
  {
    ...
    stores:
      "train.csv / val.csv datasets, trained model weights (.bin), evaluation checkpoints.",
    ...
    files: [
      "PolyGuard/01-data/train.csv",
      "PolyGuard/01-data/val.csv",
      "PolyGuard/03-models/polyguard_model/",
    ],
    endpoint: null,
  },
  {
    ...
    stores:
      "All .py files, notebooks, configs, requirements.txt — anything under 100MB.",
  ...
  },
  {
    ...
    stores:
      "Trained model weights, tokenizer files, config.json — the actual CodeBERT checkpoint.",
  ...
  },
  {
    ...
    stores:
      "Only app.py, requirements.txt, and Dockerfile. Model is fetched from HF Hub at startup.",
...
const FLOW = [
  {
    ...
    from: "Colab",
    to: "Drive",
    desc: "Downloads HF datasets → saves train.csv",
    fa: "#f59e0b",
    ta: "#4ade80",
  },
  {
    ...
    from: "Colab",
    to: "Drive",
    desc: "Reads train.csv → trains model → writes weights",
    fa: "#f59e0b",
    ta: "#4ade80",
  },
  {
    ...
    from: "Colab",
    to: "HF Hub",
    desc: "Uploads trained model via api.upload_folder()",
    fa: "#f59e0b",
    ta: "#a78bfa",
  },
  {
    ...
    from: "Colab",
    to: "GitHub",
    desc: "Pushes code + notebooks for the whole team",
    fa: "#f59e0b",
    ta: "#94a3b8",
  },
  {
    ...
    from: "HF Spaces",
    to: "HF Hub",
    desc: "Loads model via from_pretrained() at startup",
    fa: "#f97316",
    ta: "#a78bfa",
  },
  {
    ...
    from: "PolyCode",
    to: "HF Spaces",
    desc: "POST /analyze → score, findings, tips",
    fa: "var(--cyan)",
    ta: "#f97316",
  },
];
...
const RETRAIN = [
  {
    n: "01",
    title: "Add More Data",
    desc: "Open 01_data_collection.ipynb. Download bigvul or draper_vdisc from HuggingFace. Combine with existing data. Save new train.csv to Drive.",
    code: null,
  },
  {
    n: "02",
    title: "Retrain Model",
    desc: "Open 03_train_model.ipynb. Enable T4 GPU. Run all cells. New weights saved to Drive. Takes 20–40 min.",
    code: "Runtime → Change runtime type → T4 GPU",
  },
  {
    n: "03",
    title: "Push to HF Hub",
    desc: "Overwrite the old model on HF Hub so Spaces picks it up on next restart.",
    code: `api.upload_folder(\n  folder_path="Drive/PolyGuard/03-models/polyguard_model",\n  repo_id="MUHAMMADSAADAMIN/polyguard-model"\n)`,
  },
  {
    n: "04",
    title: "Restart HF Space",
    desc: "Go to your Space → Settings → Restart Space. It downloads the new model. Takes 3–5 min.",
    code: null,
  },
  {
    n: "05",
    title: "Verify Improvement",
    desc: "Send the same test snippet to /analyze. Compare confidence scores. If vuln_confidence dropped, the model got smarter.",
    code: `curl -X POST https://muhammadsaadamin-polyguard-api.hf.space/analyze \\\n  -H "Content-Type: application/json" \\\n  -d '{"code": "test code here", "language": "python"}'`,
  },
];
    ...
    >
      ...
      >
        ...
        <p style={{ color: "var(--text2)", fontSize: 14 }}>
          Five tools working as one system. Click any component to explore its
          role and data flow.
        </p>
      </motion.div>
          ...
          >
            <div
              style={{
                ...
                borderRadius: "50%",
                background: t.accent,
                boxShadow: `0 0 12px ${t.accent}70`,
                margin: "0 auto 10px",
              }}
            />
            <div
              style={{
                ...
                fontSize: 12,
                fontWeight: 700,
                color: active === t.id ? t.accent : "var(--text)",
                marginBottom: 4,
              }}
            >
              {t.label}
                  ...
                  >
                    <span
                      style={{
                        ...
                        boxShadow: `0 0 10px ${tool.accent}`,
      ...
      >
        <div className="label" style={{ marginBottom: 14 }}>
          // DATA FLOW — HOW ALL 5 TOOLS CONNECT
        </div>
        <div
          style={{
            background: "var(--bg2)",
